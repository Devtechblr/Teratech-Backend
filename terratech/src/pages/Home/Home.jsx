...
import frame from '/src/assets/Frame 64.png'
  ...
  return (
    <>
      ...
      <div className="relative w-full h-[40vh] md:h-[80vh] lg:h-[90vh] flex justify-end items-start bg-gradient-to-br from-[#fff] via-[#fff] to-[#fff] overflow-hidden">
        {/* LOGO + TEXT Section */}
        <div className="absolute top-0 left-1 sm:top-14 sm:left-4 md:top-28 md:left-16 lg:top-12 lg:left-14 py-4 px-2 z-20">
          <div className="flex items-center space-x-4">
            <img
              src={'/favicon-removebg-preview.png'}
              alt="Website Logo"
              className="w-12 sm:w-16 md:w-20 lg:w-34 h-auto object-contain"
            />
          </div>
          <div className="mt-6 sm:mt-20 flex flex-col sm:gap-4">
            <div className="flex flex-col items-start gap-1">
              <h1 className="text-[#1F2832] text-xs sm:text-2xl md:text-3xl lg:text-4xl uppercase tracking-widest">
                A High Performance
              </h1>
              <p className="text-[#1F2832] text-xs sm:text-2xl md:text-3xl lg:text-4xl uppercase tracking-widest">
                Commercial Drone
              </p>
            </div>

            <div className="bg-[#1F2832] mt-6 px-1 py-0 sm:mt-6 sm:px-6 sm:py-4 rounded-lg w-fit shadow-md">
              <h2 className="text-white text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-wide">
        ...
        <div className="relative w-full h-full overflow-x-hidden z-10">
          ...
          <Link
            to="/getitnow"
            className="absolute py-1 bottom-1 sm:bottom-8 right-0 bg-gradient-to-r from-[#1F2832] to-[#2e3e4f] text-white text-sm sm:text-xl w-30 sm:w-60 sm:py-3 font-medium shadow-lg hover:scale-105 hover:shadow-xl transition duration-300 ease-in-out text-center flex items-center justify-center rounded"
          >
            Get It Now
          </Link>
        ...
        <section className="px-4 md:px-12 lg:px-20 py-12 bg-white text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            <div className="relative overflow-hidden rounded-md shadow-md">
              <img src={drone} alt="Drone Security" className="w-full h-auto object-cover" />
            ...
            {/* Second Card */}
            <div className="relative overflow-hidden rounded-md shadow-md">
              <img src={drone} alt="Drone Civilian" className="w-full h-auto object-cover" />
