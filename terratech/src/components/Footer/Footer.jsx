  ...
  return (
    <footer className="bg-[#1F2832] text-white py-2">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[260px_1fr] gap-8 px-4 md:px-8 text-center md:text-left">
        <div className="min-w-[180px] mb-6 py-10 flex flex-col items-center md:items-start">
          <img src={('/favicon-removebg-preview.png')} alt="TerraTech Logo" className="w-40 h-35 mb-2" />
